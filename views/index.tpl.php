...
<head>
    ...
    <title>PHP CRUD AJAX, MySQL</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <button type="button" class="btn btn-primary col-1 btn-add" data-bs-toggle="modal"
        ...
        <div class="table-responsive my-3">
            <table class="table table-hover">
                ...
                <tr id="city-id">
                    ...
                    <td>Population</td>
                    <td>
                        <button class="btn btn-info btn-edit" data-bs-toggle="modal" data-bs-target="#editCity">Edit</button>
